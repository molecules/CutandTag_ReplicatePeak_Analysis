...
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/H3K4me3_C_eulerPlot.pdf" width="300">                               | <img src="/images/H3K4me3_T_eulerPlot.pdf" width="300">                                    |
...
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/H3K4me3_eulerPlot.pdf" width="300">                                 | <img src="/images/HeatPlots_All_Samples.png" width="300">                                  |
| *Euler plot showing consensus peak overlap of conditions in each mark. H3K4me3 shown.*| *Heatmap showing signal distributions for all samples midpoints.*                          |

| 5. **H3K4me3_eulerPlot**                                                              |                                                                                            |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/HeatPlots_Unique_Samples.png" width="300">                          |                                                                                            |
| *Heatmap showing signal distributions for all samples midpoints separated by sample*  |                                                                                            |
