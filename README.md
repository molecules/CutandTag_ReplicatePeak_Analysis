...
# 7) Examples of Output from Test Files in Reop
Below are some example plots generated by the pipeline.  
> **Note**: GitHub does not render PDFs inline, so the Euler plots (saved as PDF) will appear as downloadable links or previews in some browsers.

1. **H3K4me3_C_eulerPlot**  
   [H3K4me3_C_eulerPlot.pdf](/images/H3K4me3_C_eulerPlot.png)

2. **H3K4me3_T_eulerPlot**  
   [H3K4me3_T_eulerPlot.pdf](/images/H3K4me3_T_eulerPlot.png)

3. **H3K4me3_eulerPlot**  
   [H3K4me3_eulerPlot.pdf](/images/H3K4me3_eulerPlot.png)

4. **HeatPlots_All_Samples**  
   ![HeatPlots_All_Samples](/images/HeatPlots_All_Samples.png)
