...
[![DOI](https://zenodo.org/badge/898608902.svg)](https://doi.org/10.5281/zenodo.898608902)
...
A. Clone repository
```
wget https://github.com/JK-Cobre-Help/CutandTag_ReplicatePeak_Analysis/archive/refs/tags/v1.0.2.tar.gz
tar -xzf v1.0.2.tar.gz
rm v1.0.2.tar.gz
cd CutandTag_ReplicatePeak_Analysis-1.0.2
```
B. Load modules
```
module purge
