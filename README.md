...
```
wget https://github.com/JK-Cobre-Help/CutandTag_ReplicatePeak_Analysis/releases/download/v1.0.3/CutandTag_ReplicatePeak_Analysis-1.0.3.tar.gz
refs/tags/v1.0.3.tar.gz
tar -xzf CutandTag_ReplicatePeak_Analysis-1.0.3.tar.gz
rm CutandTag_ReplicatePeak_Analysis-1.0.3.tar.gz
cd CutandTag_ReplicatePeak_Analysis-1.0.3
```
B. Load modules
```
module purge
